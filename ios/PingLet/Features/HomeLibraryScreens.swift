...
struct LibraryView: View {
    ...
    private func refresh() async { loading = true; do { try await env.refreshLibrary(); error = nil } catch { env.library = env.shared.library; error = env.library.isEmpty ? "Your library could not be loaded. Check your connection and try again." : nil }; loading = false }
